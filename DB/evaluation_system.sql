...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 08, 2026 at 01:57 AM
...
(1, 'admin', '$2y$10$qgb1XVXxcMhESVNdhouDbe0pyiZ3enPkzGBOfEaB8O0Uto.kfWebG', '2026-03-25 01:11:11');
...
CREATE TABLE `evaluation` (
  ...
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `rating_engage` int(11) DEFAULT 0,
  `rating_fairness` int(11) DEFAULT 0,
  `rating_materials` int(11) DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `evaluation` (`id`, `teacher_name`, `rating`, `feedback`, `rating_comm`, `rating_mastery`, `rating_punctual`, `department`, `year_level`, `semester`, `term`, `created_at`, `rating_engage`, `rating_fairness`, `rating_materials`) VALUES
(1, 'Mr. Jerick Barnatia', 1.50, 'PWEDE NA\r\n', 2, 1, 2, 'BSIT', '1st Year', '1st Semester', 'Prelim', '2026-03-24 04:46:25', 2, 1, 1),
(2, 'Mr. Jonathan Alberto', 1.67, 'hey gyud don\'t be apreyd.\r\n', 2, 2, 2, 'BSIT', '1st Year', '2nd Semester', 'Finals', '2026-03-24 04:59:10', 1, 2, 1),
(3, 'Kyla Melissa Pascual', 2.33, '...', 3, 3, 2, 'BSCRIM', '1st Year', '1st Semester', 'Prelim', '2026-03-24 05:17:15', 2, 2, 2),
(4, 'Camille Rose Gasmino', 5.00, 'qewsw', 5, 5, 5, 'BSEDUC', '1st Year', '1st Semester', 'Prelim', '2026-03-25 02:22:07', 5, 5, 5),
(5, 'Mr. Jerick Barnatia', 1.00, 'khoy', 1, 1, 1, 'BSIT', '1st Year', '2nd Semester', 'Midterm', '2026-04-07 06:10:02', 1, 1, 1);
...
(1, 'roelle glenn aguilar', 'roelle', 'roelle@21', '202cb962ac59075b964b07152d234b70', '2026-03-23 14:32:37'),
(2, 'ANGEL KAYE BONSOBRE', 'KYY', 'angelbonsobre01@gmail.com', 'fed33392d3a48aa149a87a38b875ba4a', '2026-03-24 05:02:08'),
(4, 'Chelsea', 'Chelsea ', 'che@21', '202cb962ac59075b964b07152d234b70', '2026-04-06 07:32:34');
